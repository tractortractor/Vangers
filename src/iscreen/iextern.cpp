...
std::string iJoystickStickAxisUnknown1 = "��� #";
std::string iJoystickStickAxisUnknown2 = "axis #";

std::string iJoystickStickAxisInverted1 = "������஢����� ";
...
const char STR_NONE2[] = {static_cast<char>(0x8D), static_cast<char>(0x85), static_cast<char>(0x92)}; //cp866 - НЕТ // tractortractor's added static_cast<char>
